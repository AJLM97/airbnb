export default function Comments({ lang }) {
    return <div class="antialiased mx-auto max-w-screen">
  <h3 class="mb-4 text-lg font-semibold text-gray-900">{lang == "en" ? "Comments" : "Comentarios"}</h3>
  ...
  <div class="space-y-4">
    ...
    <div class="flex">
      ...
      <div class="flex-1 border border-stone-200 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
    ...
    <div class="flex">
      ...
      <div class="flex-1 border border-stone-200 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
        ...
        <h4 class="my-5 uppercase tracking-wide text-gray-400 font-bold text-xs">{lang == "en" ? "Replies" : "Respuestas"}</h4>
